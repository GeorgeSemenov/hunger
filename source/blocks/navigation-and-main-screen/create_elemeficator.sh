#!/bin/sh
parentName=navigation-and-main-screen
...
end1
cat navigation-and-main-screen.pug >> newFile.pug
mv -f newFile.pug  navigation-and-main-screen.pug
...
end3
cat navigation-and-main-screen.scss >> newFile.scss
mv -f newFile.scss navigation-and-main-screen.scss
cd ${fileName}
